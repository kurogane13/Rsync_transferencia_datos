...
path_programa="/home/gus/Desktop/myfiles/Tecnologia/Ubuntu/My_Bash_scripts/rsync/"
cd $path_programa 
while true; 
do
echo "######################################################"
...
do
  ...
  "+ Crear nuevo script de transferencia hacia Servidor Remoto")
	 ...
	 echo "mypwd="${PWD}/ >> scripts_conexiones_exclusion_datos/$archivo$archivo_exclusion_datos
	 echo "scripts_conexiones_exclusion_datos=scripts_conexiones_exclusion_datos/" >> scripts_conexiones_exclusion_datos/$archivo$archivo_exclusion_datos
     ...
     echo " "
     echo 'sshpass -p "$clave" rsync -auv  --ignore-missing-args --stats --update --progress --out-format="%t %f" $pathorigen --exclude-from=$mypwd$scripts_conexiones_exclusion_datos$archivo$archivo_carpetas_exclusion ssh $usuario@$servidor:$pathdestino' >> scripts_conexiones_exclusion_datos/$archivo$archivo_exclusion_datos
     ...
     echo " " >> scripts_conexiones_exclusion_datos/$archivo.sh
     echo 'sshpass -p "$clave" rsync -auv  --stats --update --progress --out-format="%t %f" $pathorigen  ssh $usuario@$servidor:$pathdestino' >> scripts_conexiones_exclusion_datos/$archivo.sh
     echo " "
     echo "$(date) NOTIFICACION - MENSAJE: El script se ha generado dentro de la carpeta: scripts_conexiones_exclusion_datos" | tee -a syslog.log
     echo " "
  ...
  "+ Crear nuevo script local de transferencia hacia directorio/disco ")
	 ...
	 echo " " >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "rsync -auvi  --stats --update --progress --out-format='%t %f' $path_de_origen --exclude-from=$mypwd$Dir/$nombre_script$archivo_exclusion_datos_local $path_de_destino" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo " "
  
     echo "echo '----------------------------------------------------------------------------------------'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo 'Detalle de datos pasados a Disco externo...'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "date " >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo 'Listando carpetas en disco externo para la ruta $path_de_destino: '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 listar_path_destino="ls -lha $path_de_destino"
	 echo $listar_path_destino >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 total_carpetas_path_destino="du -h -c --time $path_de_destino"
	 echo $total_carpetas_path_destino >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo 'El informe visto arriba, muestra el tamaño total de carpetas, fecha ultima modificacion, y ruta de cada carpeta'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "date " >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo " " >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo '----------------------------------------------------------------------------------------'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 ...
	 total_de_carpetas_origen="ls -lha $path_de_origen | wc -l"
     total_de_carpetas_destino="ls -lha $path_de_destino | wc -l"
	 size_total_origen="du -sh $path_de_origen"
	 size_total_destino="du -sh $path_de_destino"
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo 'Tamaño total de la carpeta del path de Origen: $path_de_origen'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo $size_total_origen >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo 'Tamaño total de la carpeta del path Sincronizado de destino: $path_de_origen'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo $size_total_destino >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo 'Total de carpetas en el path de Origen: $path_de_origen'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo $total_de_carpetas_origen >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo 'Total de carpetas en el path de Destino Sincronizado: $path_de_destino'" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_exclusion_datos_local
	 ...
	 echo " " >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
	 echo "rsync -auvi  --stats --update --progress --out-format='%t %f' $path_de_origen $path_de_destino" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
	 echo " "

     echo "echo '----------------------------------------------------------------------------------------'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
	 echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'Detalle de datos pasados a Disco externo...'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "date " >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'Listando carpetas en disco externo para la ruta $path_de_destino: '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
	 listar_path_destino="ls -lha $path_de_destino"
     ...
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'El informe visto arriba, muestra el tamaño total de carpetas, fecha ultima modificacion, y ruta de cada carpeta'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     
	 total_de_carpetas_origen="ls -lha $path_de_origen | wc -l"
	 total_de_carpetas_destino="ls -lha $path_de_destino | wc -l"
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'Tamaño total de la carpeta del path de Origen: $path_de_origen'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo $size_total_origen >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'Tamaño total de la carpeta del path Sincronizado de destino: $path_de_origen'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo $size_total_destino >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'Total de carpetas en el path de Origen: $path_de_origen'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo $total_de_carpetas_origen >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo 'Total de carpetas en el path de Destino Sincronizado: $path_de_destino'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo $total_de_carpetas_destino >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local

	 echo "echo 'Fecha de ultima actualizacion: '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo ' '" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "date " >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo " " >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
     echo "echo '----------------------------------------------------------------------------------------'" >> $mypwd$Dir/$nombre_script$script_sin_exclusion_datos_local
  ...
  "- Ejecutar programa excluyendo carpetas y archivos")
	 ...
	 echo " " >> rsync_log.log
	 sshpass -p "$clave" rsync -auv  --stats --update --progress --out-format="%t %f" $pathorigen --exclude-from='carpetas.log' ssh $usuario@$servidor:$pathdestino
	 echo " " >> rsync_log.log
   ...
   "- Iniciar programa sin excluir una carpeta ni archivo")
     ...
     echo "Iniciando transferencia de datos hacia $servidor..." >> rsync_log.log
     echo " " >> rsync_log.log
     sshpass -p "$clave" rsync -auv  --stats --update --progress --out-format="%t %f" $pathorigen  ssh $usuario@$servidor:$pathdestino
     echo " " >> rsync_log.log
     echo "Listando contenido de carpeta $pathdestino..." >> rsync_log.log
     echo " " >> rsync_log.log
     sshpass -p "$clave" ssh $usuario@$servidor ls -lha $pathdestino >> rsync_log.log
